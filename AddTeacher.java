...
{
    JFrame f; //either make object of JFrame or wite publicclass student extends JFrame
    ...
    long first4=(ran.nextLong()%9000L)+1000L; //generating random number
    long first=Math.abs(first4); //making the random of +ve 4 digit
    ...
    public AddTeacher ()
    {
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(getClass().getResource("/university/management/system/icons/img.jpg"));
        Image i3 = img.getImage().getScaledInstance(2048, 1152, Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);

        // id15.setLayout(new GridLayout(14,2,10,10));
        ...
        id2.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id2);
        ...
        id3.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id3);
        ...
        id4.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id4);
        ...
        id5.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id5);
        ...
        id6.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id6);
        ...
        id7.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id7);
        ...
        id9.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id9);
        ...
        id10.setFont(new Font("serif", Font.ITALIC, 20));
        ...
        id11.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id11);
        ...
        id12.setFont(new Font("serif", Font.ITALIC, 20));
        id15.add(id12);
    ...
    public void actionPerformed (ActionEvent ae)
    {
        ...
        if (ae.getSource()==b)
        {
            ...
            {
                conn cc = new conn();
                String q= "insert into teacher values('"+a+"','"+bb+"','"+d+"','"+c+"','"+j+"','"+g+"', '"+h+"','"+i+"','"+ff+"','"+k+"','"+l+"','"+m+"','"+e+"')";
