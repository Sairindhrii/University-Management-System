...
class UpdateStudent implements ActionListener
{
    ...
    public void actionPerformed (ActionEvent ae)
    {
        if (ae.getSource()==b)
        {
            ...
            {
                conn con = new conn();
                String str="update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',dob='"+t3.getText()+"',age='"+t4.getText()+"',adhar='"+t5.getText()+"',email='"+t6.getText()+"',class_x='"+t7.getText()+"',class_xii='"+t8.getText()+"',phone='"+t9.getText()+"',course='"+t11.getText()+"',branch='"+t12.getText()+"',address='"+t13.getText()+"' where rollno='"+t10.getText()+"'";
        ...
        if (ae.getSource()==b2)
        {
            ...
            {
                conn con= new conn();
                String str="select * from student where rollno='"+t10.getText()+"'";
